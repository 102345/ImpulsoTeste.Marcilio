...
{
    public abstract class MarcilioWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MarcilioWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MarcilioWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MarcilioDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MarcilioDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MarcilioDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MarcilioDbContext, Task<T>> func)
        {
            T result;
